...
export const en = {
  ...
  voice: {
    ...
    micLang: "This phone cannot listen in this language yet. Write it here instead.",
    ...
    noVoice: "This phone has no voice for this language. The words are on the screen.",
