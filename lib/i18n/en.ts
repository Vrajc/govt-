...
export const en = {
  ...
  photo: {
    ...
    deniedBodyFace:
      "This photo has to be taken now, so it cannot be picked from the gallery. Allow the camera for this page — look for the camera sign in the address bar — and try again.",
    retryCamera: "Open the camera again",
  ...
  demo: {
    ...
    prefillDone: "Filled in. Ramanbhai Patel, 700020240123.",
  ...
  voice: {
    ...
    ask: "Ask",
    noMic: "This browser cannot listen. Write what you need instead.",
    ...
    micNetwork: "The internet went away while listening. Say it once more, or write it here.",
    noVoice: "There is no voice for this language on this device. The words are on the screen.",
    ...
    stepPapers: "Photograph the papers with the camera. Nothing has to be printed.",
